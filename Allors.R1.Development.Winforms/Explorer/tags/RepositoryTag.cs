// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RepositoryTag.cs" company="Allors bvba">
...
namespace Allors.R1.Development.Repository.WinForms
{
    ...
    public sealed class RepositoryTag : Tag
    {
        public RepositoryTag(Repository repository)
        {
