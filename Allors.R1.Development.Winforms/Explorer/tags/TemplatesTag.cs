// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TemplatesTag.cs" company="Allors bvba">
...
namespace Allors.R1.Development.Repository.WinForms
{
    ...
    public sealed class TemplatesTag : Tag
    {
        public TemplatesTag(Repository repository)
        {
