...
//-------------------------------------------------------------------------------------------------
namespace Allors.R1.Development.Repository.Meta
{
    ...
    /// </summary>
    public class RepositoryMetaObjectChangedEventArgs : MetaObjectChangedEventArgs
    {
        /// <summary>
        ...
        /// </param>
        public RepositoryMetaObjectChangedEventArgs(Repository repository, MetaObject metaObject) 
            : base(metaObject)
        {
