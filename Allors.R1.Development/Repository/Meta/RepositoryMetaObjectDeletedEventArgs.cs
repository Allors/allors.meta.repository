...
namespace Allors.R1.Development.Repository.Meta
{
    ...
    /// </summary>
    public class RepositoryMetaObjectDeletedEventArgs : MetaObjectDeletedEventArgs
    {
        /// <summary>
        ...
        /// The meta Object Id.
        /// </param>
        public RepositoryMetaObjectDeletedEventArgs(Repository repository, Guid metaObjectId)
            : base(metaObjectId)
        {
